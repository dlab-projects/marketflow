...
# -*- coding: utf-8 -*-
#
# Marketflow documentation build configuration file, created by
...
htmlhelp_basename = 'Marketflowdoc'
...
latex_documents = [
    (master_doc, 'Marketflow.tex', 'Marketflow Documentation',
     'Dav Clark, Jayanth Devarajan, Max Eddy, Daniel Kim, Jie Li, Dillon Niederhut, Raymond Yang, Raymond Yee', 'manual'),
]
